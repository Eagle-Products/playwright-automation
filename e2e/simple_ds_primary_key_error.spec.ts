...
test('test', async ({ page }) => {
	...
	await page.getByRole('textbox', { name: 'Name' }).fill('50-FUND-DATA1');
	...
	await expect(page.getByText('Datasource must include at least one primary key (unique) column ')).toBeVisible();
});
